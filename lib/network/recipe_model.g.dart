...
// 1. Retorna una nueva clase APIRecipeQuery
APIRecipeQuery _$APIRecipeQueryFromJson(Map<String, dynamic> json) =>
    APIRecipeQuery(
      // 2. Mapea una llave q a un campo query
      query: json['q'] as String,
      //3. Mapea el integer from al campo from, mapea los otros campos
      from: json['from'] as int,
      to: json['to'] as int,
      more: json['more'] as bool,
      count: json['count'] as int,
      //4. Mapea cada elemento de la lista hits a una instancia de la clase
      // APIHits.
